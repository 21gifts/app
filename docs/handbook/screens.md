...
Click **No gifts yet** (German: **Noch ohne Geschenk**) — only loaded notes with exactly zero sats appear, oldest first like All. Bob is visible; paid Ada and Carol are hidden. This includes notes without a receiving wallet. The four filters use a two-column grid for readable labels on mobile. Active remains the default.
...
Today’s outbound gifts strip collapsed above the mode selector: **Today 2 gifts · $4.00** (aria-label **Show today’s gifts**). Recipient rows and the day link are not visible until expand.

![21.gifts welcome today gifts](images/welcome-today-gifts.png)

### Variant: today-gifts-open

Same strip expanded: **alice · $3.00**, **bob · $1.00**, and **All gifts this day** linking to `/stats/{day}`.

![21.gifts welcome today gifts open](images/welcome-today-gifts-open.png)
