...
- **What the user sees:** Idle: heading **Sign in to 21.gifts** and button **Log in with your Lightning wallet**. After start: QR of the uppercase LNURL, primary **Open Wallet of Satoshi**, secondary **Open default Lightning wallet**, **Copy login code**, plus expiry/error/signed-in states.
