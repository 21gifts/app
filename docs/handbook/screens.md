...
The amount is kept and **Create invoice** is gone. Desktop shows the Bitcoin invoice QR and **Pay**. A smartphone shows only **Pay**.
...
The open till: the shop sticker's storefront above the name, then time left, the sat amount, and **Pay**. Desktop also shows the Bitcoin invoice QR. A smartphone does not. No gift glyph and no amount field. A failed mint keeps the charge and shows **Could not create the invoice.**
