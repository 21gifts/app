...
- **Calls:** `AppShell`, `Wordmark`, `WelcomeScreen`, `ForumLoader`, `ForumBoard`, `RequirementsOverlay`, `SegmentedControl`, `SignedInChrome`, `OnboardingGate`, `prepareForumPhoto`, `prepareForumVideo`, `fetchMessagePhoto`, `forumVideoSrc`, `fetchReplies`, `visibleForumMessages`.
...
- **Calls:** `AppShell`, `Wordmark`, `RulesPage`, `RulesDocument`, `LanguageSwitcher`, `ThemeSwitcher`.
- **Auth:** None.
