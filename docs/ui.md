...
| `topRight` | `LanguageSwitcher tone="light"`                                                                                                                                 | `SignedInChrome` (Menu; no ThemeSwitcher, no LanguageSwitcher)                                                                                                                                                                                                                                                                                                                                                 |>>>>>>> ac305fb8 (01a0abad - List /trust-chain on the ProfileChromeLeft AppShell table)
