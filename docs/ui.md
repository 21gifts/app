...
- Amount (forum reply only): `Field` `forum.replyAmountLabel`, placeholder `forum.replyAmountPlaceholder` (`1`), `inputMode="numeric"`, `w-24`. Empty or `0` invoices 1 sat for non-exempt visitors.
