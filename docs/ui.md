...
3. Optional photo/video (`rounded-xl`, `max-h-80`, `block h-auto shrink-0`, `object-contain`). Multiple stills (`photoCount > 1`) use `ForumPhotoGallery` (full-width stack in the page scrollport, `current/total` chip, dots).
