...
const en = {
  ...
  'pwa.iosLead': 'On iPhone this takes three taps in Safari.',
  'pwa.iosShare': 'Tap Share (square with the arrow).',
  'pwa.iosAdd': 'Tap Add to Home Screen.',
  'pwa.iosOpen': 'Leave Open as Web App on, then tap Add.',
  'pwa.close': 'Close',
...
const de = {
  ...
  'pwa.iosLead': 'Auf dem iPhone sind das drei Taps in Safari.',
  'pwa.iosShare': 'Tippen Sie auf Teilen (Quadrat mit Pfeil).',
  'pwa.iosAdd': 'Tippen Sie auf Zum Home-Bildschirm.',
  'pwa.iosOpen': 'Lassen Sie „Als Web-App öffnen“ an, dann Hinzufügen.',
  'pwa.close': 'Schließen',
  'aria.primary': 'Primär',
  'aria.menu': 'Menü',
...
const es = {
  ...
  'pwa.iosLead': 'En iPhone son tres toques en Safari.',
  'pwa.iosShare': 'Toque Compartir (el cuadrado con la flecha).',
  'pwa.iosAdd': 'Toque Añadir a pantalla de inicio.',
  'pwa.iosOpen': 'Deje Activado Abrir como app web y toque Añadir.',
  'pwa.close': 'Cerrar',
...
const fil = {
  ...
  'pwa.iosLead': 'Sa iPhone, tatlong tap sa Safari.',
  'pwa.iosShare': 'I-tap ang Share (parisukat na may arrow).',
  'pwa.iosAdd': 'I-tap ang Add to Home Screen.',
  'pwa.iosOpen': 'Iwanang naka-on ang Open as Web App, tapos Add.',
  'pwa.close': 'Isara',
