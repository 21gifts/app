...
const de = {
  ...
  'forum.errorEmpty': 'Bitte schreiben Sie eine Nachricht oder fügen Sie ein Foto hinzu',
  ...
  'forum.errorUnsupported': 'Bitte verwenden Sie ein Foto im JPEG-, PNG- oder WebP-Format',
  'forum.errorTooLarge': 'Das Foto darf höchstens 1 MB gross sein',
