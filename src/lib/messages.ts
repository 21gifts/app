...
const en = {
  ...
  'la.errorExample': 'Enter your own Wallet of Satoshi address, not the example',
...
const es = {
  ...
  'la.errorExample': 'Introduce tu propia dirección de Wallet of Satoshi, no el ejemplo',
...
const fil = {
  ...
  'la.errorExample': 'Ilagay ang sarili mong Wallet of Satoshi address, hindi ang example',
