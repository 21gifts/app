...
const en = {
  ...
  'forum.addShopAccount': 'Add an account',
  'forum.editShopAccount': 'Edit account',
  'forum.shopAccountLabel': 'Username',
  'forum.shopAccountSave': 'Save account',
  'forum.shopAccountRemove': 'Remove account',
  'forum.shopAccountSaveFailed': 'The account could not be saved. Please try again.',
  'forum.shopAccountMissing': 'No account with that username.',
  ...
  'moderate.payouts.lead':
    'Daily grant for the last seven UTC days. Today is on the right. Moderator stipends and welcome gifts are not included.',
  'moderate.payouts.empty': 'Nobody was entitled in these seven days.',
  'moderate.payouts.error': 'Could not load the payout table. Please try again.',
  'moderate.payouts.legend.blocked': 'Not entitled',
  'moderate.payouts.legend.missed': 'Entitled, not collected',
  'moderate.payouts.legend.paid': 'Payout received',
  'moderate.payouts.column.name': 'Name',
  'moderate.payouts.today': 'today',
  'moderate.payouts.cell.blocked': '{name}, {date}, not entitled',
  'moderate.payouts.cell.missed': '{name}, {date}, entitled, not collected',
...
const de = {
  ...
  'forum.addShopAccount': 'Konto hinzufügen',
  'forum.editShopAccount': 'Konto bearbeiten',
  'forum.shopAccountLabel': 'Benutzername',
  'forum.shopAccountSave': 'Konto speichern',
  'forum.shopAccountRemove': 'Konto entfernen',
  'forum.shopAccountSaveFailed':
    'Das Konto konnte nicht gespeichert werden. Bitte erneut versuchen.',
  'forum.shopAccountMissing': 'Kein Konto mit diesem Benutzernamen.',
  ...
  'moderate.payouts.lead':
    'Tagesförderung der letzten sieben UTC-Tage. Heute steht rechts. Moderatoren-Stipendien und Willkommensgeschenke zählen nicht.',
  'moderate.payouts.empty': 'In diesen sieben Tagen war niemand berechtigt.',
  'moderate.payouts.error':
    'Die Tabelle konnte nicht geladen werden. Bitte versuchen Sie es erneut.',
  'moderate.payouts.legend.blocked': 'Nicht berechtigt',
  'moderate.payouts.legend.missed': 'Berechtigt, nicht abgeholt',
  'moderate.payouts.legend.paid': 'Auszahlung erhalten',
  'moderate.payouts.column.name': 'Name',
  'moderate.payouts.today': 'heute',
  'moderate.payouts.cell.blocked': '{name}, {date}, nicht berechtigt',
  'moderate.payouts.cell.missed': '{name}, {date}, berechtigt, nicht abgeholt',
...
const es = {
  ...
  'forum.addShopAccount': 'Añadir una cuenta',
  'forum.editShopAccount': 'Editar la cuenta',
  'forum.shopAccountLabel': 'Nombre de usuario',
  'forum.shopAccountSave': 'Guardar la cuenta',
  'forum.shopAccountRemove': 'Quitar la cuenta',
  'forum.shopAccountSaveFailed': 'No se pudo guardar la cuenta. Inténtalo de nuevo.',
  'forum.shopAccountMissing': 'No hay ninguna cuenta con ese nombre de usuario.',
  ...
  'moderate.payouts.lead':
    'Ayuda diaria de los últimos siete días UTC. Hoy está a la derecha. Los estipendios de moderación y los regalos de bienvenida no cuentan.',
  ...
  'moderate.payouts.legend.missed': 'Con derecho, no cobrado',
  'moderate.payouts.legend.paid': 'Pago recibido',
  'moderate.payouts.column.name': 'Nombre',
  'moderate.payouts.today': 'hoy',
  'moderate.payouts.cell.blocked': '{name}, {date}, sin derecho',
...
const fil = {
  ...
  'forum.addShopAccount': 'Magdagdag ng account',
  'forum.editShopAccount': 'Baguhin ang account',
  'forum.shopAccountLabel': 'Username',
  'forum.shopAccountSave': 'I-save ang account',
  'forum.shopAccountRemove': 'Alisin ang account',
  'forum.shopAccountSaveFailed': 'Hindi ma-save ang account. Pakisubukan muli.',
  'forum.shopAccountMissing': 'Walang account na may ganitong username.',
  ...
  'moderate.payouts.lead':
    'Araw-araw na grant sa huling pitong araw na UTC. Nasa kanan ang ngayon. Hindi kasama ang stipend ng moderator at ang welcome gift.',
  ...
  'moderate.payouts.legend.missed': 'May karapatan, hindi nakuha',
  'moderate.payouts.legend.paid': 'Natanggap ang bayad',
  'moderate.payouts.column.name': 'Pangalan',
  'moderate.payouts.today': 'ngayon',
  'moderate.payouts.cell.blocked': '{name}, {date}, walang karapatan',
  'moderate.payouts.cell.missed': '{name}, {date}, may karapatan, hindi nakuha',
