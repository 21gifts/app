...
const en = {
  ...
  'home.step3Body':
    'After you log in, write on the member forum. Others can send Bitcoin to a post; satoshis land in your Wallet of Satoshi, not ours. The platform never sees the money.',
  ...
  'forum.emptyPaid': 'No messages with sats yet.',
  ...
  'forum.payAmountLabel': 'Amount (sats)',
  'forum.payAmountPlaceholder': '21',
  'forum.payContinue': 'Continue',
  'forum.payCancel': 'Cancel',
  'forum.payOpenWallet': 'Open Wallet of Satoshi',
  'forum.payInvoiceQr': 'Bitcoin payment QR code',
  'forum.payErrorAmount': 'Enter a whole number of sats greater than zero',
  ...
  'profile.scaleSat': 'Sat',
  'profile.scaleUsd': 'USD',
  'profile.chartSat': 'Given and received in sats',
...
const de = {
  ...
  'home.step3Body':
    'Nach der Anmeldung schreiben Sie im Mitgliederforum. Andere können Bitcoin an einen Beitrag senden; die Satoshis landen in Ihrer Wallet of Satoshi, nicht bei uns. Die Plattform sieht das Geld nicht.',
  ...
  'forum.emptyPaid': 'Noch keine Nachrichten mit Sats.',
  ...
  'forum.payAmountLabel': 'Betrag (Sats)',
  'forum.payAmountPlaceholder': '21',
  'forum.payContinue': 'Weiter',
  'forum.payCancel': 'Abbrechen',
  'forum.payOpenWallet': 'Wallet of Satoshi öffnen',
  'forum.payInvoiceQr': 'Bitcoin-Zahlungs-QR-Code',
  'forum.payErrorAmount': 'Ganze Zahl von Sats grösser als null eingeben',
  ...
  'profile.scaleSat': 'Sat',
  'profile.scaleUsd': 'USD',
  'profile.chartSat': 'Gegeben und erhalten in Sats',
...
const es = {
  ...
  'home.step3Body':
    'Tras iniciar sesión, escribe en el foro de miembros. Otras personas pueden enviar Bitcoin a una publicación; los satoshis llegan a tu Wallet of Satoshi, no a la nuestra. La plataforma nunca ve el dinero.',
  ...
  'forum.emptyPaid': 'Aún no hay mensajes con sats.',
  ...
  'forum.payAmountLabel': 'Monto (sats)',
  'forum.payAmountPlaceholder': '21',
  'forum.payContinue': 'Continuar',
  'forum.payCancel': 'Cancelar',
  'forum.payOpenWallet': 'Abrir Wallet of Satoshi',
  'forum.payInvoiceQr': 'Código QR de pago Bitcoin',
  'forum.payErrorAmount': 'Introduce un número entero de sats mayor que cero',
  ...
  'profile.scaleSat': 'Sat',
  'profile.scaleUsd': 'USD',
  'profile.chartSat': 'Donado y recibido en sats',
...
const fil = {
  ...
  'home.step3Body':
    'Pagkatapos mag-log in, sumulat sa member forum. Puwedeng magpadala ng Bitcoin ang iba sa isang post; sa iyong Wallet of Satoshi bumabagsak ang mga satoshi, hindi sa amin. Hindi nakikita ng platform ang pera.',
  ...
  'forum.emptyPaid': 'Wala pang mensahe na may sats.',
  'forum.loading': 'Loading…',
  ...
  'forum.payAmountLabel': 'Halaga (sats)',
  'forum.payAmountPlaceholder': '21',
  'forum.payContinue': 'Magpatuloy',
  'forum.payCancel': 'Kanselahin',
  'forum.payOpenWallet': 'Buksan ang Wallet of Satoshi',
  'forum.payInvoiceQr': 'QR code ng bayad sa Bitcoin',
  'forum.payErrorAmount': 'Maglagay ng buong numero ng sats na higit sa zero',
  ...
  'profile.scaleSat': 'Sat',
  'profile.scaleUsd': 'USD',
  'profile.chartSat': 'Ibinigay at natanggap sa sats',
