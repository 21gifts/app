...
const en = {
  ...
  'login.createPasskey': 'Create a login',
...
const de = {
  ...
  'login.createPasskey': 'Login erstellen',
  'login.continuePasskey': 'Anmelden',
...
const es = {
  ...
  'login.createPasskey': 'Crear un login',
...
const fil = {
  ...
  'login.createPasskey': 'Gumawa ng login',
