...
export function LightningAddressForm(
  ...
  const inputClass =
    'w-full min-h-11 rounded-2xl border border-app-border-strong bg-app-card px-4 py-2 text-base text-app-fg transition focus-visible:border-app-fg disabled:opacity-50';
