        ...
        <div className="flex flex-col items-stretch gap-3">
          <div className="flex items-start gap-2">
            ...
            <textarea
              ...
              className="min-h-24 min-w-0 flex-1 resize-y rounded-2xl border border-app-border-strong bg-app-card px-4 py-2 text-sm text-app-fg whitespace-pre-wrap transition focus-visible:border-app-fg disabled:opacity-50"
            />
            <IconButton
              type="button"
              variant="primary"
