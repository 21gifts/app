...
vi.mock('@/components/NotificationsLoader', () => ({
  NotificationsLoader: () => <div data-testid="notifications-loader" />,
}));
...
describe('NotificationsPage', () => {
  it('renders the notifications loader inside signed-in chrome', () => {
    renderWithLocale(<NotificationsPage />);
    expect(screen.getByTestId('notifications-loader')).toBeTruthy();
