...
import ModeratorGroupPage from '@/app/moderate/group/page';
...
vi.mock('@/components/ModeratorGroupScreen', () => ({
  ModeratorGroupScreen: () => <div data-testid="moderator-group-screen" />,
}));
...
describe('ModeratorGroupPage', () => {
  it('renders the moderator-group screen inside signed-in chrome', () => {
