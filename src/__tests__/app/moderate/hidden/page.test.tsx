...
import HiddenNotesPage from '@/app/moderate/hidden/page';
...
vi.mock('@/components/HiddenNotesScreen', () => ({
  HiddenNotesScreen: () => <div data-testid="hidden-notes-screen" />,
}));
...
describe('HiddenNotesPage', () => {
  it('renders the hidden-notes screen inside signed-in chrome', () => {
    renderWithLocale(<HiddenNotesPage />);
    expect(screen.getByTestId('hidden-notes-screen')).toBeTruthy();
