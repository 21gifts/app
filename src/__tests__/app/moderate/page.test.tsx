...
vi.mock('@/components/ModerateScreen', () => ({
  ModerateScreen: () => <div data-testid="moderate-screen" />,
}));
...
describe('ModeratePage', () => {
  it('renders the moderate screen inside signed-in chrome', () => {
    renderWithLocale(<ModeratePage />);
    expect(screen.getByTestId('moderate-screen')).toBeTruthy();
