...
vi.mock('@/components/FundingApplicationsScreen', () => ({
  FundingApplicationsScreen: () => <div data-testid="funding-applications-screen" />,
}));
...
describe('FundingApplicationsPage', () => {
  it('renders the applications screen inside signed-in chrome', () => {
