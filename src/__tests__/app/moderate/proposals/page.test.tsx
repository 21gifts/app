...
import ProposalsPage from '@/app/moderate/proposals/page';
...
vi.mock('@/components/ProposalsScreen', () => ({
  ProposalsScreen: () => <div data-testid="proposals-screen" />,
}));
...
describe('ProposalsPage', () => {
  it('renders the proposals screen inside signed-in chrome', () => {
