...
export const SCREEN_VARIANTS = [
  ...
  },
  {
    ...
    needle: '3. Contact stays in the app',
  },
  {
    route: '/setup/rules',
    id: 'wanted',
    ...
    needle: "getByRole('heading', { name: 'Wanted' })",
  },
  {
    route: '/setup/rules',
    id: 'allowed',
  ...
  },
  {
    ...
    needle: "getByRole('heading', { name: 'Rather not' })",
  },
  {
    route: '/setup/rules',
    id: 'forbidden',
