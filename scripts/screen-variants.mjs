...
export const SCREEN_VARIANTS = [
  ...
  },
  {
    route: '/shops',
    id: 'ask-amount',
    image: 'shops-ask-amount.png',
    visual: 'state-shops-ask-amount',
    needle: 'state /shops ask-amount',
  },
  {
    route: '/shops',
    id: 'ask-daily',
    image: 'shops-ask-daily.png',
    visual: 'state-shops-ask-daily',
    needle: 'state /shops ask-daily',
  },
  {
    route: '/shops',
    id: 'error-ask',
    image: 'shops-error-ask.png',
    visual: 'state-shops-error-ask',
    needle: 'state /shops error-ask',
  },
  {
    route: '/shops',
    id: 'error-ask-daily',
    image: 'shops-error-ask-daily.png',
    visual: 'state-shops-error-ask-daily',
    needle: 'state /shops error-ask-daily',
  },
  {
    route: '/shops',
    id: 'ask-photos',
    image: 'shops-ask-photos.png',
    visual: 'state-shops-ask-photos',
    needle: 'state /shops ask-photos',
  },
  {
    route: '/shops',
    id: 'ask-text',
    image: 'shops-ask-text.png',
    visual: 'state-shops-ask-text',
    needle: 'state /shops ask-text',
  },
  {
    route: '/shops',
    id: 'ask-preview',
    image: 'shops-ask-preview.png',
    visual: 'state-shops-ask-preview',
    needle: 'state /shops ask-preview',
  },
  {
    route: '/messages/[id]',
    id: 'translate',
